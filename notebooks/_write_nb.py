...
cells.append(md("md-01",["---\n","## Section 0 -- Setup"]))

# ── code-02 ───────────────────────────────────────────────────────────────
cells.append(code("code-02",[
...
cells.append(md("md-05",["---\n","## Section 2 -- Training / Evaluation Split"]))

# ── code-06 ───────────────────────────────────────────────────────────────
cells.append(code("code-06",[
...
cells.append(md("md-07",["---\n","## Section 3 -- Transforms and Datasets"]))

# ── code-08 ───────────────────────────────────────────────────────────────
cells.append(code("code-08",[
"IMG_SIZE  = 224\n","BATCH     = 64\n","\n",
"train_tfm = T.Compose([\n",
...
cells.append(md("md-11",["---\n","## Section 5 -- Pretrained ResNet18 for Grayscale"]))

# ── code-12 ───────────────────────────────────────────────────────────────
cells.append(code("code-12",[
...
cells.append(md("md-18",["---\n","## Section 8 -- Evaluation Pairs (CEDAR test set)"]))

# ── code-19 ───────────────────────────────────────────────────────────────
cells.append(code("code-19",[
...
cells.append(md("md-20",["---\n","## Section 9 -- Standard Metrics"]))

# ── code-21 ───────────────────────────────────────────────────────────────
cells.append(code("code-21",[
...
cells.append(md("md-25",["---\n","## Section 11 -- Embedding Space (PCA)"]))

# ── code-26 ───────────────────────────────────────────────────────────────
cells.append(code("code-26",[
...
cells.append(md("md-27",["---\n","## Section 12 -- Summary"]))

# ── code-28 ───────────────────────────────────────────────────────────────
cells.append(code("code-28",[
...
out = pathlib.Path(r'w:/SRH study/Master Thesis/Deep Metric Learning Framework Offline Signature Verification/notebooks/03_arcface_multidataset.ipynb')
